import { deleteAllSchema } from '../../../model/query'
...
const Home = ({ navigation }) => {
    ...
    const onExit = async () => {
        ...
        await AsyncStorage.removeItem('visitDate');
        deleteAllSchema().then(() => {
    ...
    return (
        <>
                    ...
                    <ScrollView>
                        ...
                        >
                            <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 10, paddingHorizontal: 20 }}>
                                ...
                                <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-around', }}>
                                    <Text style={[styles.nameKey, { fontSize: 16 }]}>خروج</Text>
                                </View>
                            </View>
                        </Ripple>
                    </ScrollView>
            ...
            <AlertModal
                ...
                description="با خروج از برنامه تمامی اطلاعات این کاربر پاک خواهد شد,آیا مایل هستید؟"
                ok="موافقم"
